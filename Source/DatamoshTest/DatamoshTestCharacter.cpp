...
//////////////////////////////////////////////////////////////////////////
// ADatamoshTestCharacter

ADatamoshTestCharacter::ADatamoshTestCharacter()
{
...
void ADatamoshTestCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
}

void ADatamoshTestCharacter::RagdollAndDatamosh()
{
	IsMoshing = not IsMoshing;
...
void ADatamoshTestCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ADatamoshTestCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &ADatamoshTestCharacter::Look);
		EnhancedInputComponent->BindAction(ToggleDatamosh, ETriggerEvent::Started, this,
		                                   &ADatamoshTestCharacter::RagdollAndDatamosh);
	}
	else
	{
...
void ADatamoshTestCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
